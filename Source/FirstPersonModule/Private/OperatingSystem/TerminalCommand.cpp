...
FTerminalCommandResult UTerminalCommand::ExecuteCommand(ATerminalApplication* Terminal, FTerminalCommandExecutionParameters CommandParameters)
{
	...
	if (bBlueprintImplementedFunction)
		...
		return OnCommandExecuted(Terminal, CommandParameters);
}
