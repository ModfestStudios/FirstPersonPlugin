...
//=============================================CURRENTLY NOT BEING USED ANYMORE 12/23/2024 - MIGRATED CODE TO BE STRICTLY COMPONENT=============================================
 ...
 * 
 */
class FIRSTPERSONMODULE_API IInteractiveShapeInterface
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION()
		virtual void DenyInteraction(AActor* User) {};
