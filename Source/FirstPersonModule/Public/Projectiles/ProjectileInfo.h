...
class FIRSTPERSONMODULE_API UProjectileInfo : public UPrimaryDataAsset
{
	GENERATED_BODY()
public:
	...
	UPROPERTY(EditAnywhere, Category = "General", meta = (EditCondition = "bUseVariableDamage", EditConditionHides))
		FRuntimeFloatCurve DamageCurve;
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "General", meta = (Units = "m/s"))
